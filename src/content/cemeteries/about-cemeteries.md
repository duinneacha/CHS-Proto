...
<h1>Our Local Cemeteries</h1>
   ...
   <figure class="FigureLeft">
        <img src="/assets/Cemeteries/SampleHeadstone.jpg" alt="ANCOImage">
    ...
    <p class="indentedText">
        ...
        328 datasheets was first fully scanned for posperity. Then, the datasheets were used to create
    ...
    <figure class="FigureCenter">
        <img src="/assets/Cemeteries/StDavidsSiteplan.jpg" alt="ImageSitePlan">
    <figcaption>Old St David's Abbey Cemetery</figcaption>
    </figure>
    <p class="indentedText">
